...
describe("bind guess number and create number", function () {
    ...
    describe("6 times ", function () {
        ...
        it("guess 6 times ,and all wrong ,then get' not right'", function () {
            var game = new Game(create_random_number_func);
            var numbers = ['1243', '1323', '1232', '2143', '3241', '3421'];
            var result = "";
        ...
        it("guess 6 times ,and 3th is right ,then get 'you win' ", function () {
            var game = new Game(create_random_number_func);
            var numbers = ['1243', '1323', '1234', '1232', '2143', '3241'];
            var result = "";
            var i = 0;
        ...
        it("guess 6 times ,and 6th is right , then get 'you win'", function () {
            var game = new Game(create_random_number_func);
            var numbers = ['1243', '1323', '1232', '2143', '3241', '1234'];
            var result = "";
 ...
 describe("page test",function(){
     ...
     it("when guess button on page click ,then Game.prototype.guess will be invoke",function(){
